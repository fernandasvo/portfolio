window.onload = function() {
  ...
  var N_NODES = 800; // Number of nodes to put in visualization
  var P_RELATION = 0.001; //probablity that any two nodes are connected
  ...
  new mo.Graphics({
    ...
    init: function(){
      ...
      this.forces.forcesForNetwork(network, 80, new mo.Point(0, 0), 1, true);
    },
